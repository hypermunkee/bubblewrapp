javascript:void((function() {
        var grabYouTubeIds = function() {
                ...
                if (pattern.test(url)) {
                        ...
                        var views = parseInt($(".watch-view-count strong").html().replace(/\D/g,''), 10);
                ...
                $('li.video-list-item > a.related-video').each(function(index, element) {
                        ...
                        for (var i = 0; i < children.length; i++) {
                                ...
                                } else if (child.className == 'stat view-count') {
                                    views = parseInt(child.innerText.replace(/\D/g,''), 10);
                                    if (title != '') {
                                        break;
                                    }
                                }
        ...
        if (!($ = window.jQuery)) { /* typeof jQuery=='undefined' works too */
                ...
                $('body').append('<div style="width:900px !important; margin:-225px 0 0 -450px !important; max-height:1000px !important;" class="modal hide" id="myModal">'+
